...
const STAR_IMAGE = require("../ratingDefault/Images/star.png");
const HEART_IMAGE = require("../ratingDefault/Images/heart.png");
const ROCKET_IMAGE = require("../ratingDefault/Images/rocket.png");
const BELL_IMAGE = require("../ratingDefault/Images/bell.png");
...
export default class Rating extends Component {
  static defaultProps = {
    type: "custom",
    ratingImage: require("../ratingExample/Images/star.png"),
    ratingColor: "#f1c40f",
